...
$VIServer = "esximaster.my-v-world.fr"
$VIUsername = 'root'
...
$NestedESXiApplianceOVA = '/users/nicolas/Documents/Resources/VMware/6.7/Nested_ESXi6.7u3_Appliance_Template_v1/Nested_ESXi6.7u3_Appliance_Template_v1.ovf'
$VCSAInstallerPath = '/users/nicolas/Documents/Resources/VMware/6.7/VMware-VCSA-all-6.7.0-15132721'
...
$NestedESXiHostnameToIPs = @{
    "esx01.my-v-world.fr" = "139.178.72.92"
    "esx02.my-v-world.fr" = "139.178.72.93"
    "esx03.my-v-world.fr" = "139.178.72.94"
}
...
$VCSAIPAddress = "139.178.72.91"
$VCSAHostname = "vcsa.my-v-world.fr" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
...
$VMGateway = "139.178.72.89"
$VMDNS = "147.75.207.207"
$VMNTP = "pool.ntp.org"
$VMPassword = "VMware1!"
$VMDomain = "my-v-world.fr"
...
$NewVCDatacenterName = "MYVWORLD"
$NewVCVSANClusterName = "VSANCLUSTER01"
...
if($deployVCSA -eq 1) {
    if($DeploymentTarget -eq "ESXI") {
        ...
        if($enableVerboseLoggingToNewShell -eq 1) {
            ...
            Start-process pwsh -argument "-nologo -noprofile -executionpolicy bypass -command Get-Content $verboseLogFile -Tail 2 -Wait"
        }

        My-Logger "Deploying VCSA ..."
        Invoke-Expression "$($VCSAInstallerPath)/vcsa-cli-installer/mac/vcsa-deploy install --no-ssl-certificate-verification --accept-eula --acknowledge-ceip $($ENV:Temp)/jsontemplate.json"| Out-File -Append -LiteralPath $verboseLogFile
    } else {
        # Deploy using the VCSA CLI Installer
